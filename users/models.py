...
class SellerProfile(models.Model):
    ...
    categories = models.ManyToManyField('products.Category', related_name="categories", blank=True)
...
class UserLog(models.Model):
    ...
    last_product_viewed = models.ForeignKey('products.Product', null=True, blank=True, on_delete=models.SET_NULL,
