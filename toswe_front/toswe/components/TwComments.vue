<template>
  <section class="max-w-3xl mx-auto mt-12 px-4">
    <!-- Titre -->
    <h3 class="text-xl font-bold text-[#7D260F] mb-6">Commentaires</h3>
    ...
    <!-- Formulaire -->
    <form @submit.prevent="addComment" class="bg-white p-4 border border-gray-200 rounded-lg shadow-sm space-y-4">
      <!-- Choix de la note -->
